$(document).ready(function() {
    ...
    var timelineColors = ['#2F81AE','#A42510','#DE9D18','#256384','#C0400D',
      '#E1C020','#1C4766','#DD5C00','#96AC53','#132D45','#DE7C0F','#599780'];
    ...
    function render(type,extent) {
        ...
        $.get("extract", function(json) {
            ...
            //only draw if the date is not empty
            if (raw.filterApps(dateRange).length > 0) {
...
//     }
    ...
    function barMouseout(raw,dateRange){
        ...
        else { drawKeyframes(dateRange,raw); }
    }
